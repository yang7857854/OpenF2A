...
---------------------- INPUT FILES ---------------------------------------------
"IEA-22-280-RWT\IEA-22-280-RWT-Semi_ElastoDyn.dat" EDFile      - Name of file containing ElastoDyn input parameters (quoted string)
...
"IEA-22-280-RWT\IEA-22-280-RWT-Semi_AeroDyn15.dat" AeroFile    - Name of file containing aerodynamic input parameters (quoted string)
"IEA-22-280-RWT\IEA-22-280-RWT-Semi_ServoDyn.dat" ServoFile   - Name of file containing control and electrical-drive input parameters (quoted string)
"IEA-22-280-RWT\IEA-22-280-RWT-Semi_SeaState_PotMod.dat"    SeaStFile   - Name of file containing sea state input parameters (quoted string)
"IEA-22-280-RWT\IEA-22-280-RWT-Semi_HydroDyn_PotMod.dat" HydroFile   - Name of file containing hydrodynamic input parameters (quoted string)
"none"                 SubFile     - Name of file containing sub-structural input parameters (quoted string)
"IEA-22-280-RWT\IEA-22-280-RWT-Semi_MoorDyn.dat" MooringFile - Name of file containing mooring system input parameters (quoted string)
