...
---------------------- INPUT FILES ---------------------------------------------
"../5MW_Baseline/5MW_OC4DeepCwindSemi_ElastoDyn_Pitch_Freedecay.dat"    EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
"../5MW_Baseline/5MW_BeamDyn.dat"    BDBldFile(1)    - Name of file containing BeamDyn input parameters for blade 1 (quoted string)
"../5MW_Baseline/5MW_BeamDyn.dat"    BDBldFile(2)    - Name of file containing BeamDyn input parameters for blade 2 (quoted string)
"../5MW_Baseline/5MW_BeamDyn.dat"    BDBldFile(3)    - Name of file containing BeamDyn input parameters for blade 3 (quoted string)
"../5MW_Baseline/5MW_InflowWind_10mps.dat"    InflowFile      - Name of file containing inflow wind input parameters (quoted string)
"../5MW_Baseline/5MW_OC3Hywind_AeroDyn.dat"    AeroFile        - Name of file containing aerodynamic input parameters (quoted string)
"../5MW_Baseline/5MW_OC4DeepCwindSemi_ServoDyn.dat"    ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string)
"../5MW_Baseline/SeaState_StillWater.dat"    SeaStFile       - Name of file containing sea state input parameters (quoted string)
"../5MW_Baseline/5MW_OC4DeepCwindSemi_HydroDyn.dat"    HydroFile       - Name of file containing hydrodynamic input parameters (quoted string)
"unused"      SubFile         - Name of file containing sub-structural input parameters (quoted string)
"../5MW_Baseline/5MW_OC4DeepCwindSemi_MoorDyn.dat"    MooringFile     - Name of file containing mooring system input parameters (quoted string)
"unused"      IceFile         - Name of file containing ice input parameters (quoted string)
---------------------- OUTPUT --------------------------------------------------
False         SumPrint        - Print summary data to "<RootName>.sum" (flag)
          1   SttsTime        - Amount of time between screen status messages (s)
     100000   ChkptTime       - Amount of time between creating checkpoint files for potential restart (s)
