...
---------------------- INPUT FILES ---------------------------------------------
"../5MW_Baseline/5MW_OC4DeepCwindSemi_ElastoDyn.dat"    EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
...
"../5MW_Baseline/5MW_InflowWind_Turb_11.4.dat"    InflowFile      - Name of file containing inflow wind input parameters (quoted string)
