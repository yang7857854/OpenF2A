...
---------------------- INPUT FILES --------------------------------------------- 
"IEA15MW\IEA-15-240-RWT-UMaineSemi_ElastoDyn_PitchDecay.dat"    EDFile          - Name of file containing ElastoDyn input parameters (quoted string) 
...
"IEA15MW\IEA-15-240-RWT_InflowFile_12mps.dat"    InflowFile      - Name of file containing inflow wind input parameters (quoted string) 
