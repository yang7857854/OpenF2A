...
---------------------- INPUT FILES --------------------------------------------- 
"IEA15MW\IEA-15-240-RWT-UMaineSemi_ElastoDyn_SurgeDecay.dat"    EDFile          - Name of file containing ElastoDyn input parameters (quoted string) 
...
"IEA15MW\SeaState.dat"    SeaStFile       - Name of file containing sea state input parameters (quoted string)
