...
---------------------- INPUT FILES --------------------------------------------- 
"IEA15MW\IEA-15-240-RWT-UMaineSemi_ElastoDyn_HeaveDecay.dat"    EDFile          - Name of file containing ElastoDyn input parameters (quoted string) 
...
"IEA15MW\IEA-15-240-RWT_InflowFile_12mps.dat.dat"    InflowFile      - Name of file containing inflow wind input parameters (quoted string) 
"IEA15MW\IEA-15-240-RWT-UMaineSemi_AeroDyn15.dat"  AeroFile     - Name of file containing aerodynamic input parameters (quoted string) 
"IEA15MW\IEA-15-240-RWT-UMaineSemi_ServoDyn.dat"    ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string) 
"IEA15MW\SeaState_SW.dat"    SeaStFile       - Name of file containing sea state input parameters (quoted string)
"IEA15MW\IEA-15-240-RWT-UMaineSemi_HydroDyn.dat"      HydroFile       - Name of file containing hydrodynamic input parameters (quoted string) 
"none"                 SubFile         - Name of file containing sub-structural input parameters (quoted string) 
"IEA15MW\IEA-15-240-RWT-UMaineSemi_MoorDyn.dat"      MooringFile     - Name of file containing mooring system input parameters (quoted string) 
