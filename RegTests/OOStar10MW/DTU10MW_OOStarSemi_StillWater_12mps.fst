...
DTU 10.0 MW Wind Turbine with OO-Star semi configuration, for use in offshore analysis
---------------------- SIMULATION CONTROL --------------------------------------
False         Echo            - Echo input data to <RootName>.ech (flag)
"FATAL"       AbortLevel      - Error level when simulation should abort (string) {"WARNING", "SEVERE", "FATAL"}
       4500   TMax            - Total run time (s)
...
---------------------- INPUT FILES ---------------------------------------------
"10MWRWT/DTU10MW_OOStarSemi_ElastoDyn.dat"    EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
"unused"    BDBldFile(1)    - Name of file containing BeamDyn input parameters for blade 1 (quoted string)
"unused"    BDBldFile(2)    - Name of file containing BeamDyn input parameters for blade 2 (quoted string)
"unused"    BDBldFile(3)    - Name of file containing BeamDyn input parameters for blade 3 (quoted string)
"10MWRWT/DTU10MW_OOStarSemi_InflowWind_12mps.dat"    InflowFile      - Name of file containing inflow wind input parameters (quoted string)
"10MWRWT/DTU_10MW_AeroDyn.dat"    AeroFile        - Name of file containing aerodynamic input parameters (quoted string)
"10MWRWT/DTU10MW_OOStarSemi_ServoDyn.dat"    ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string)
"10MWRWT/DTU10MW_OOStarSemi_SeaState_StillWater.dat"    SeaStFile       - Name of file containing sea state input parameters (quoted string)
"10MWRWT/DTU10MW_OOStarSemi_HydroDyn.dat"    HydroFile       - Name of file containing hydrodynamic input parameters (quoted string)
"unused"      SubFile         - Name of file containing sub-structural input parameters (quoted string)
"10MWRWT/DTU10MW_OOStarSemi_MoorDyn.dat"    MooringFile     - Name of file containing mooring system input parameters (quoted string)
