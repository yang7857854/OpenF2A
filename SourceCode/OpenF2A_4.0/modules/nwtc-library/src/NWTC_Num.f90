...
!! vector x to the equation Ax = b.
   ...
   REAL(R8Ki),     INTENT(IN )  :: AugMatIn (NumEq, NumEq+1 )                      !< Augmented matrix passed into this subroutine ( AugMatIn = [ A b ]
   REAL(R8Ki),     INTENT(OUT)  :: x (NumEq)                                       !< Solution vector
   ...
   REAL(R8Ki)                   :: AugMat   (NumEq,( NumEq + 1 ))                  ! The augmented matrix [A b]
   ...
   DO L = 1,NumEq             ! Loop through all rows
      ...
      IF ( EqualRealNos( AugMat(L,L), 0.0_R8Ki ) ) THEN
         ErrStat = ErrID_Fatal
